...
X_gray_std_90_percent, X_gray_std_10_percent, y_90_percent, y_10_percent = train_test_split(X_gray_std, y,
...
for i in [20,40,60,80,160,320]:
    ...
    f = open("C:/Users/Gebruiker/MEGA/Master DSE/Data Mining/Assignments/Assignment 1/saved_files/knn_pca_score{}factors.pkl".format(i), "wb")
